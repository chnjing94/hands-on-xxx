package com.demo.webfluxws.config;

import com.demo.webfluxws.entity.WebSocketSender;
import com.demo.webfluxws.handler.QueueStatusHandler;
...
public class WebSocketConfiguration {
    ...
    public ConcurrentHashMap<String, Set<WebSocketSender>> queueSubscriber() {
        ConcurrentHashMap<String, Set<WebSocketSender>> map = new ConcurrentHashMap<>();
        map.put("testqueue", Collections.newSetFromMap(new ConcurrentHashMap<>()));
        return map;
    }
}
